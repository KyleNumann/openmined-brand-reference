...
This working guide is **model-independent** and lives here in plain markdown so any AI tool — not just Claude — gets the same instant understanding when it ingests the repo. `CLAUDE.md` simply imports this file.
